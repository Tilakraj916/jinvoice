...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.sergiopino.service.impl.PasswordTokenManager#generateRecoveryToken(com.sergiopino.model.User)
     */
    @Override
    ...
    /**
     * @see com.sergiopino.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.sergiopino.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.sergiopino.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
